...
| 8080 / tcp      | AdGuard Home  | LAN/Tailscale | 192.168.1.200:8080 / 100.80.202.44:8080  | UI ativa em 8080. |
...
| 8000 / tcp      | Portainer     | LAN/Tailscale | 192.168.1.200:8000                       | Túnel/Edge (opcional, aqui está ativo). |
| 9000 / tcp      | Portainer     | LAN/Tailscale | 192.168.1.200:9000                       | UI HTTP (legado) — mantida. |
| 9443 / tcp      | Portainer     | LAN/Tailscale | https://192.168.1.200:9443               | UI HTTPS (autoassinado por omissão). |